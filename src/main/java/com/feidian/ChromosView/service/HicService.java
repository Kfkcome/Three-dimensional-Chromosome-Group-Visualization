...
public interface HicService {
    ...
    Boolean generateAnnotation2DMap(String species, String cultivar, String tissue, String chromosome, String displayOption, String normalizationType, Integer colorValue, Integer clarity, Boolean loop, Boolean tad, String tadSoftware, String loopSoftware, HttpServletResponse response);
